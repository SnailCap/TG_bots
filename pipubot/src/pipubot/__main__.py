...
from core.runtime import AppConfig, run_app
...
def main() -> None:
    ...
    config = AppConfig(
        ...
        config_root=str(Path(__file__).resolve().parent.parent.parent / "resources" / "config"),
        ui_binding_modules=("pipubot.ui.components",),
